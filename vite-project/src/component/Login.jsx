...
function CreateAccount() {
  ...
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          <img class="w-8 h-8 mr-2" src="https://cdn.jim-nielsen.com/macos/512/tasks-to-do-lists-planner-2023-02-14.png"/>
          To-Do App    
      </a>
              ...
              <form onSubmit={handlesubmit} class="space-y-4 md:space-y-6" action="#">
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Already have an account?
                       <Link to="/" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Create Account</Link>
                  </p>
          </div>
      </div>
  </div>
